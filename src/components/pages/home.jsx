  ...
  return (
    <>
      <Paper elevation={0} sx={{ backgroundColor: "background.main" }}>
        ...
        <Experience
          showHeading={true}
          imageSrc="images/marmik_patel.jpg"
        ...
        <Experience
          ...
          description="I engineered a web application that advertised the company's tutoring services, allowed parents to register students and contact the manager, and provided students with academic worksheets. After I deployed the website, student registration increased 400%."
        />
